      ...
      {clientNavigation.map((item) => {
        ...
        return (
          <NavLink
            className={({ isActive }) =>
              cn(
                'flex h-[3.1rem] min-w-0 flex-col items-center justify-center gap-0.5 rounded-xl px-1 text-center text-[0.62rem] font-semibold leading-none text-slate-500 transition',
                'dark:text-slate-300',
                isActive &&
